  ...
  integrations: [
    sitemap({
      ...
      serialize(item) {
        ...
        else if (/\/(cheap-hotels|5-star-hotels|4-star-hotels|3-star-hotels|hotel-apartments|family-hotels|beach-hotels|hotels-with-pool)\/$/.test(path)) { item.priority = 0.9; item.changefreq = 'daily'; }
